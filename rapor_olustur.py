...
govde(
    ...
    "ödüllendirilmesine yol açabilir [13][14][10]. Projenin amacı, kullanıcının ilgi "
...
govde(
    "Etkileşim-optimize sıralama sistemlerinin olumsuz içeriği yapısal olarak "
    "ödüllendirdiğine dair belgelenmiş, kamuya mal olmuş kanıtlar mevcuttur. 2021'de "
    "Wall Street Journal'ın \"The Facebook Files\" dizisi, Facebook'un kendi iç veri "
    "biliminin \"öfke\" tepkisi içeren gönderilerin çok daha fazla etkileşim aldığını "
    "bulduğunu; bu tepkinin 2017-2018'de algoritmada beğeniden 5 kat ağırlıklandırıldığını "
    "ortaya koymuştur [13]. Akademik literatür de bu örüntüyü doğrulamaktadır: yaklaşık "
    "105.000 haber başlığı varyasyonunun analiz edildiği bir çalışmada, ortalama "
    "uzunluktaki bir başlıkta her ek negatif kelimenin tıklama oranını %2,3 artırdığı "
    "gösterilmiştir [10]; olumsuz haberlerin sosyal medyada daha fazla paylaşıldığı da "
    "ayrıca doğrulanmıştır [11][12]. Pasif/olumsuz içerik tüketiminin kaygı ve stresle "
    "ilişkisi literatürde orta güçte ama tutarlı şekilde gösterilmektedir [4][5]. "
