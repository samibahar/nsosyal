...
govde(
    ...
    "ihtiyaç duymadan standart sunucu donanımında çalışabilir. LLM çağrısı yalnızca "
    "kullanıcı başına haftada bir üretilen öz-farkındalık raporunda ve isteğe bağlı "
    "olarak (talep üzerine, otomatik değil) üretilen uzman özetinde kullanılır; bu da "
    "toplam çağrı hacmini düşük tutar. Bu mimari tercih, platforma milyonlarca "
    "etkileşimde dahi düşük işletme maliyetiyle ölçeklenebilirlik sağlar; NSosyal'in "
    "~700 bin'i aşkın kullanıcısına, mimarinin doğası gereği büyük bir altyapı yatırımı "
    "olmadan teorik olarak hizmet verebilecek bir temel sunar; bu iddia şu aşamada gerçek "
    "bir yük testiyle değil, mimari tasarımla desteklenmektedir. Etkinlik açısından, "
    "refah katmanının içeriği "
